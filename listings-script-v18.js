            ...
            <div class="card-content">
              ...
              <div class="card-details">
                <div style="display: flex; align-items: center; gap: 3px;">
                  <svg viewBox="0 0 512 512" fill="currentColor" style="width: 14px; height: 14px; flex-shrink: 0;">
                ...
                <div style="display: flex; align-items: center; gap: 3px;">
                  <svg viewBox="0 0 512 512" fill="currentColor" style="width: 14px; height: 14px; flex-shrink: 0;">
                    <path d="M492 343.861c11.046 0 20-8.954 20-20v-4.053c0-27.487-15.748-51.365-38.694-63.086v-146.723c0-44.112-35.888-80-80-80h-274.612c-44.112 0-80 35.888-80 80v146.724c-22.946 11.721-38.694 35.599-38.694 63.085v104.052c0 11.046 8.954 20 20 20h18.694v18.141c0 11.046 8.954 20 20 20s20-8.954 20-20v-18.141h354.611v18.141c0 11.046 8.954 20 20 20s20-8.954 20-20v-18.141h18.695c11.046 0 20-8.954 20-20s-8.954-20-20-20h-452v-84.052c0-16.951 13.769-30.745 30.71-30.787h370.58c16.941.042 30.71 13.836 30.71 30.787v4.053c0 11.046 8.954 20 20 20zm-256-94.84h-157.306v-42.357c0-22.056 17.944-40 40-40h77.306c22.056 0 40 17.944 40 40zm40 0v-42.357c0-22.056 17.944-40 40-40h77.306c22.056 0 40 17.944 40 40v42.357zm-157.306-179.022h274.611c22.056 0 40 17.944 40 40v27.401c-11.774-6.826-25.439-10.737-40-10.737h-77.305c-23.869 0-45.33 10.508-60 27.14-14.67-16.632-36.131-27.14-60-27.14h-77.306c-14.561 0-28.226 3.911-40 10.737v-27.402c0-22.056 17.944-39.999 40-39.999z"/>
                  </svg>
                ...
                <div style="display: flex; align-items: center; gap: 3px;">
                  <svg viewBox="0 0 512 512" fill="currentColor" style="width: 14px; height: 14px; flex-shrink: 0;">
                    <path d="m492 236.01h-60v-166.548c0-73.259-98.873-96.414-131.555-31.054l-26.334 52.666c-4.939 9.879-.936 21.892 8.944 26.832 9.881 4.939 21.893.935 26.833-8.944l26.334-52.666c13.861-27.723 55.778-17.942 55.778 13.166v166.548h-372c-11.046 0-20 8.954-20 19.999v79.072c0 65.765 46.249 120.924 107.93 134.684l-6.484 13.651c-4.739 9.977-.493 21.906 9.484 26.645 9.936 4.721 21.889.532 26.646-9.484l13.065-27.503h210.719l13.065 27.503c4.744 9.989 16.679 14.218 26.646 9.484 9.978-4.739 14.224-16.669 9.484-26.645l-6.484-13.651c61.68-13.761 107.929-68.919 107.929-134.684v-79.072c0-11.045-8.954-19.999-20-19.999zm-20 99.071c0 54.035-43.963 97.995-98 97.995h-236c-54.037 0-98-43.96-98-97.995v-59.072h432z"/>
                  </svg>
